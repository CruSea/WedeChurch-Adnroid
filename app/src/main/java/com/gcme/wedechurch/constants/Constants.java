package com.gcme.wedechurch.constants;
...
public interface Constants {
    ...
    public static final String SENDER_ID = "234234234234";  //GOOGLE API Sender ID

    public static final String WEB_SITE = "http://news.ifsoft.ru/";  //web site url address

    public static final String CLIENT_ID = "1";  //Client ID | For identify the application | Example: 12567

    public static final String API_DOMAIN = "http://news.ifsoft.ru/";  //url address to which the application sends requests
