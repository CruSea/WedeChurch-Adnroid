...
public class faveventsadapter extends BaseAdapter {
	...
	public faveventsadapter(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		final ViewHolder holder;
				...
				convertView = mInflater.inflate(R.layout.fav_events_item, parent,
						false);
				holder = new ViewHolder();
				holder.eventimage = (ImageView) convertView
						.findViewById(R.id.faveventimage);
				holder.eventitemholder = (LinearLayout) convertView
						.findViewById(R.id.faveventitemholder);
				holder.travelHeader = (TextView) convertView
						.findViewById(R.id.faveventtitle);
				holder.eventdate = (TextView) convertView
						.findViewById(R.id.faveventdate);
				holder.eventtime = (TextView) convertView
				.findViewById(R.id.faveventtime);
				holder.eventcategory = (TextView) convertView
				.findViewById(R.id.faveventcategory);
	...
	private static class ViewHolder {
		...
		public LinearLayout eventitemholder;
	}
