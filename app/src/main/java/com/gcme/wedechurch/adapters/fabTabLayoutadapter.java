...
public class fabTabLayoutadapter extends HorizontalScrollView {
    ...
    public fabTabLayoutadapter(Context context) {
        this(context, null);
    }

    public fabTabLayoutadapter(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public fabTabLayoutadapter(Context context, AttributeSet attrs, int defStyle) {
    ...
    /**
     * Set the {@link android.support.v4.view.ViewPager.OnPageChangeListener}. When using {@link fabTabLayoutadapter} you are
