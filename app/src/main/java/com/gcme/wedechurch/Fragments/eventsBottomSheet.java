 ...
 */
public class eventsBottomSheet extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view= inflater.inflate(R.layout.fragment_events_bottom_sheet, container, false);
        mDynamicListView = (DynamicListView) view.findViewById(R.id.bottomsheet_event_listview);
        // Inflate the layout for this fragment
