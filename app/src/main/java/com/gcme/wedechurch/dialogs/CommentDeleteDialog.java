package com.gcme.wedechurch.dialogs;
...
public class CommentDeleteDialog extends DialogFragment implements Constants {
    ...
    OnClickListener positiveListener = new OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            alertPositiveListener.onCommentDelete(position);
        }
    };
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        b.setMessage(getText(R.string.label_delete_comment));
